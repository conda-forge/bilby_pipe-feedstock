...
Once the `conda-forge` channel has been enabled, `bilby_pipe` can be installed with:

```
conda install bilby_pipe
```

It is possible to list all of the versions of `bilby_pipe` available on your platform with:
